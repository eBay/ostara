...
public class TaskService {
   ...
   @Path("/echo/{message}")
   @Produces("text/plain")
   public String echo(@PathParam("message")
   String message) {
      return message;
   }
   ...
   public Object query(@QueryParam("jobId")
   String jobId) {
   ...
   @Path("/task")
   @Produces({ "application/json" })
   public Object submitTask(@QueryParam("taskName")
   String taskName) {
   ...
   @Path("/upg")
   @Produces({ "application/json" })
   public Object upgrade(@QueryParam("gitURL")
